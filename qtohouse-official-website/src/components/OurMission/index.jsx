...
function OurMission() {
  return (
    <div className="flex flex-col items-center p-4 md:p-6 bg-white rounded-lg shadow-md max-w-full md:max-w-sm">
      <FlagIcon className="text-yellow-500 text-4xl md:text-5xl mb-3 md:mb-4" />
      <h1 className="text-xl md:text-2xl font-bold text-gray-800 mb-3 md:mb-4">Our Mission</h1>
