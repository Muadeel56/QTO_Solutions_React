...
function UserSidebar() {
  ...
  return (
    <div className="absolute max-h-full">
      <Sidebar collapsed={isCollapsed} backgroundColor="#1F2937" className=" mx-6 my-8 w-64 h-full shadow-lg rounded-lg">
        <Menu iconShape="square">
          ...
          {/* Companies SubMenu */}
          <SubMenu title="Companies" label="Companies" className="text-yellow-500" icon={<BusinessIcon sx={{ color: '#D97706' }} />}>
          ...
          {/* Users SubMenu */}
          <SubMenu title="Users" label="Users" className="text-yellow-500" icon={<GroupIcon sx={{ color: '#D97706' }} />}>
            <MenuItem className="text-yellow-500">
            ...
            <MenuItem className="text-yellow-500">
              <Link to="/user/permissions" className="text-yellow-500">Permissions</Link>
            </MenuItem>
          </SubMenu>

          {/* Projects SubMenu */}
          <SubMenu title="Projects" label="Projects" className="text-yellow-500" icon={<WorkIcon sx={{ color: '#D97706' }} />}>
            <MenuItem className="text-yellow-500">
              <Link to="/user/project-list" className="text-yellow-500">List of Projects</Link>
            </MenuItem>
            <MenuItem className="text-yellow-500">
              <Link to="/user/create-project" className="text-yellow-500">Create Project</Link>
            </MenuItem>
          </SubMenu>
