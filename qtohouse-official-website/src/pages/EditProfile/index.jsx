  ...
  return (
    <div className="container mx-auto p-8">
      <div className="w-full lg:w-2/3 xl:w-1/2 mx-auto bg-white shadow-lg rounded-lg">
        <h1 className="text-3xl font-semibold text-gray-900 text-center py-6 border-b border-gray-200">
          Edit Profile
        </h1>
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          {/* Input fields for Full Name, DOB, Gender, etc. */}
          <div className="flex flex-col">
            <label htmlFor="fullName" className="text-sm font-medium text-gray-700 mb-2">Full Name</label>
            <input
              type="text"
              id="fullName"
              name="fullName"
              ...
              className="border border-gray-300 rounded-lg p-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-yellow-500"
            />
          </div>
          ...
          {/* Nationality */}
          <div className="flex flex-col">
            <label htmlFor="nationality" className="text-sm font-medium text-gray-700 mb-2">
              Nationality
            </label>
            <input
              type="text"
