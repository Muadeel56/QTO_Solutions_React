    ...
    <div className="relative w-full min-h-screen flex flex-col">
      ...
      <div className="w-full h-[60vh] sm:h-[70vh] md:h-[80vh] relative">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center bg-black bg-opacity-70 space-y-6 px-4">
          ...
          <div className="w-full sm:w-[90%] md:w-[70%] lg:w-[60%] bg-gray-900 bg-opacity-80 text-white p-4 sm:p-6 md:p-8 rounded-xl shadow-lg flex flex-wrap items-center justify-around text-center space-y-4 sm:space-y-0 border-t-8 border-b-8 border-yellow-500">
