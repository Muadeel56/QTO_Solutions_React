  ...
  return (
    <div className="w-full bg-gray-100">
      ...
      <div className="min-h-screen flex flex-col items-center pb-16">
        ...
        {/* About Us Section */}
        <div className="w-full max-w-screen-lg p-8 bg-white mt-10 rounded-lg shadow-lg">
          <h1 className="text-3xl font-bold text-gray-800 mb-6 text-center border-b-4 border-yellow-500 pb-4">
            About Us
          </h1>
